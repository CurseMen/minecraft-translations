  ...
  return (
    <header className="w-full max-w-7xl text-center py-6 md:py-8 mb-6 flex flex-wrap justify-between items-center gap-y-4">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <button onClick={onNewsClick} className="minecraft-btn px-3 py-2 text-xs sm:px-4 sm:py-3 sm:text-sm md:text-base">
          Новости
        </button>
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="minecraft-btn minecraft-btn-telegram p-2 sm:p-3" 
